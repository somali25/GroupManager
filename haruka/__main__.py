...
PM_START = """Hello {}, my name is {somali tech}!

You know how hard it is sometimes to manage group so here is the solution for you

I'm group manager bot and Anti-spam for somali tech🃏

Activate Anti-spam protection in your BM by this command : 
/antispam on 

Made from the source code of [Khaalid 🇸🇴](t.me/mohamett_updywahab)

Special thanks to [this person](t.me/masterjiraiya_boy) for helping me.
